export const hero = [
  {
    id: 1,
    cover: "../images/hero/iglesia-Sopetran.jpg",
    catgeory: "Turismo",
    title: "Sopetrán Uno de los mejores municipios turisticos",
    authorName: "Felipe Lujan",
    authorImg: "../images/author.jpg",
    time: "20 Ago - 2025",
    desc: [
      {
        para1: "Sopetrán se erige como uno de los mejores municipios turísticos de Antioquia gracias a su incomparable ubicación en la margen occidental del Río Cauca, que le regala un paisaje exuberante donde se fusionan el valle fértil y las montañas. Este privilegiado entorno natural es la base para una oferta ecoturística de primer nivel, con atractivos como las famosas cascadas de Santa Bárbara, ideales para el avistamiento de aves, el senderismo y la conexión con la naturaleza.",
      },
      {
        para2: "Más allá de su riqueza natural, el municipio es una joya histórica y cultural viviente. Fundado en 1616, Sopetrán conserva con orgullo un patrimonio arquitectónico colonial invaluable, coronado por la imponente Iglesia de Nuestra Señora de Sopetrán, una basílica menor que domina el parque principal y se erige como un monumento nacional.",
      },
      {
        para3: "La experiencia en Sopetrán se completa con una vibrante agenda cultural que refleja la autenticidad y el fervor de su gente. Eventos de profundo calado como la Semana Santa, declarada Patrimonio Cultural de la Nación por su solemnidad y belleza, y las tradicionales Fiestas de la Loza, que rinden homenaje a las ancestrales artesanías en barro, atraen a visitantes de todas partes.",
      },
    ],
    details: [
      {
      ...
      { para1: "Descubre la magia de Sopetrán, Antioquia, un destino donde la historia cobra vida entre calles empedradas y paisajes bañados por el Río Cauca. Déjate seducir por la majestuosidad de su Basílica Menor, refresca tus sentidos en las cristalinas cascadas de Santa Bárbara y vive la autenticidad de sus tradiciones, como las emblemáticas Fiestas de la Loza. Sopetrán te espera con los brazos abiertos para ofrecerte una experiencia única llena de cultura" },
      {
  ...
  {
    id: 2,
    cover: "../images/sope.jpg",
    catgeory: "Deportes",
    title: "Intercolegiados Sopetrán ",
    authorName: "alex",
    authorImg: "../images/author.jpg",
    time: "28 Jul - 20225",
    desc: [
      {
        para1: "En Sopetrán se encendió la llama del Subregional de los Juegos Intercolegiados 2025 Noticias Juegos Intercolegiados Sopetrán se vistió de fiesta para recibir a cerca de 1.700 jóvenes deportistas en el inicio del Subregional de los Juegos Intercolegiados 2025, una cita multideportiva que reúne a los mejores talentos estudiantiles del Occidente antioqueño. Este evento, organizado por Indeportes Antioquia, se convierte en la vitrina perfecta para promover valores como el respeto, la inclusión y el juego limpio, y posiciona a Sopetrán como un referente del deporte escolar en Colombia.",
      },
      {
        para2: "La inauguración, realizada el martes 22 de julio, fue un desfile cargado de música, alegría y orgullo regional, encabezado por Alejandro Aguinaga Silva, jugador de fútbol sala local, quien encendió la antorcha que simboliza los sueños de cientos de atletas. Con nueve disciplinas en competencia —entre ellas patinaje, fútbol, atletismo, baloncesto, tenis de mesa y voleibol— y la participación de 19 municipios, el evento promete jornadas de alta emoción hasta el sábado 26 de julio.",
      },
      {
    ...
    details: [
      {
        title: "Ven y Visitanos",
      },
      { para1: "Descubre la magia de Sopetrán, Antioquia, un destino donde la historia cobra vida entre calles empedradas y paisajes bañados por el Río Cauca. Déjate seducir por la majestuosidad de su Basílica Menor, refresca tus sentidos en las cristalinas cascadas de Santa Bárbara y vive la autenticidad de sus tradiciones, como las emblemáticas Fiestas de la Loza. " },
  ...
  },
  {
    ...
    catgeory: "fashion",
    title: "No hay escapatoria a las nuevas cámaras de velocidad de alta tecnología",
    authorName: "rina",
    authorImg: "../images/author.jpg",
    time: "22 Jul - 2025",
    desc: [
